...
let CatNumerosPageModule = class CatNumerosPageModule {
};
...
let CatNumerosPage = class CatNumerosPage {
    constructor(router) {
        this.router = router;
    }
    regresar_categoria() {
...
//# sourceMappingURL=cat-numeros-cat-numeros-module-es2015.js.map