...
let LetraDPageModule = class LetraDPageModule {
};
...
let LetraDPage = class LetraDPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-d-letra-d-module-es2015.js.map