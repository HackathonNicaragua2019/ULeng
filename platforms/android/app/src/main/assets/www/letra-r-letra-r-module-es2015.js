...
let LetraRPageModule = class LetraRPageModule {
};
...
let LetraRPage = class LetraRPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-r-letra-r-module-es2015.js.map