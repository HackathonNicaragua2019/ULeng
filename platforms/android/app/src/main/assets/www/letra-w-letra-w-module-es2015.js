...
let LetraWPageModule = class LetraWPageModule {
};
...
let LetraWPage = class LetraWPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-w-letra-w-module-es2015.js.map