...
var CategoriasPage = /** @class */ (function () {
    function CategoriasPage(authSvc, router, afAuth) {
        this.authSvc = authSvc;
        this.router = router;
        this.afAuth = afAuth;
    }
    CategoriasPage.prototype.home = function () {
        this.router.navigate(["/home"]);
    };
    CategoriasPage.prototype.onLogout = function () {
        console.log('Salir!');
        this.afAuth.auth.signOut();
        this.router.navigateByUrl('/login');
    };
    CategoriasPage.ctorParameters = function () { return [
