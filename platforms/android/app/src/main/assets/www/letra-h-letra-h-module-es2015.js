...
let LetraHPageModule = class LetraHPageModule {
};
...
let LetraHPage = class LetraHPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-h-letra-h-module-es2015.js.map