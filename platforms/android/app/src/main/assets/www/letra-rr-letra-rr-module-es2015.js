...
let LetraRrPageModule = class LetraRrPageModule {
};
...
let LetraRrPage = class LetraRrPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-rr-letra-rr-module-es2015.js.map