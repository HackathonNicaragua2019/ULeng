...
var LetraFPageModule = /** @class */ (function () {
    function LetraFPageModule() {
    }
...
var LetraFPage = /** @class */ (function () {
    function LetraFPage(router) {
        this.router = router;
        this.ocultar = false;
    }
    LetraFPage.prototype.home = function () {
        this.router.navigate(["/categorias"]);
    };
    LetraFPage.prototype.regresar_categoria = function () {
        this.router.navigate(["/cat-abecedario"]);
    };
    LetraFPage.prototype.siguiente = function () {
        this.router.navigate(["/letra-g"]);
    };
    LetraFPage.prototype.anterior = function () {
        this.router.navigate(["/letra-e"]);
    };
    LetraFPage.prototype.accion = function () {
        this.ocultar = !this.ocultar;
    };
    LetraFPage.ctorParameters = function () { return [
...
//# sourceMappingURL=letra-f-letra-f-module-es5.js.map