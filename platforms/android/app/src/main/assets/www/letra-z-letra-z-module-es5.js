...
var LetraZPageModule = /** @class */ (function () {
    function LetraZPageModule() {
    }
...
var LetraZPage = /** @class */ (function () {
    function LetraZPage(router) {
        this.router = router;
        this.ocultar = false;
    }
    LetraZPage.prototype.home = function () {
        this.router.navigate(["/categorias"]);
    };
    LetraZPage.prototype.regresar_categoria = function () {
        this.router.navigate(["/cat-abecedario"]);
    };
    LetraZPage.prototype.anterior = function () {
        this.router.navigate(["/letra-y"]);
    };
    LetraZPage.prototype.accion = function () {
        this.ocultar = !this.ocultar;
    };
    LetraZPage.ctorParameters = function () { return [
...
//# sourceMappingURL=letra-z-letra-z-module-es5.js.map