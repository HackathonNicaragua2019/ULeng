...
let CatAnimalesPageModule = class CatAnimalesPageModule {
};
...
let CatAnimalesPage = class CatAnimalesPage {
    constructor(router) {
        this.router = router;
    }
    regresar_categoria() {
...
CatAnimalesPage.ctorParameters = () => [
...
//# sourceMappingURL=cat-animales-cat-animales-module-es2015.js.map