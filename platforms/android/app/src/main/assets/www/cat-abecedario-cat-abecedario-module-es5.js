...
var CatAbecedarioPageModule = /** @class */ (function () {
    function CatAbecedarioPageModule() {
    }
    ...
    return CatAbecedarioPageModule;
}());
...
var CatAbecedarioPage = /** @class */ (function () {
    function CatAbecedarioPage(router) {
        this.router = router;
    }
    CatAbecedarioPage.prototype.regresar_categoria = function () {
        this.router.navigate(["/categorias"]);
    };
    CatAbecedarioPage.prototype.home = function () {
        this.router.navigate(["/home"]);
    };
    CatAbecedarioPage.ctorParameters = function () { return [
...
//# sourceMappingURL=cat-abecedario-cat-abecedario-module-es5.js.map