...
var LetraQPageModule = /** @class */ (function () {
    function LetraQPageModule() {
    }
...
var LetraQPage = /** @class */ (function () {
    function LetraQPage(router) {
        this.router = router;
        this.ocultar = false;
    }
    LetraQPage.prototype.home = function () {
        this.router.navigate(["/categorias"]);
    };
    LetraQPage.prototype.regresar_categoria = function () {
        this.router.navigate(["/cat-abecedario"]);
    };
    LetraQPage.prototype.siguiente = function () {
        this.router.navigate(["/letra-r"]);
    };
    LetraQPage.prototype.anterior = function () {
        this.router.navigate(["/letra-p"]);
    };
    LetraQPage.prototype.accion = function () {
        this.ocultar = !this.ocultar;
    };
    LetraQPage.ctorParameters = function () { return [
...
//# sourceMappingURL=letra-q-letra-q-module-es5.js.map