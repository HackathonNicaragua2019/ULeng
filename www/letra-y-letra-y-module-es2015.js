...
let LetraYPageModule = class LetraYPageModule {
};
...
let LetraYPage = class LetraYPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-y-letra-y-module-es2015.js.map