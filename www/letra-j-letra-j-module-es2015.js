...
let LetraJPageModule = class LetraJPageModule {
};
...
let LetraJPage = class LetraJPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-j-letra-j-module-es2015.js.map