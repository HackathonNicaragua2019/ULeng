...
let LetraSPageModule = class LetraSPageModule {
};
...
let LetraSPage = class LetraSPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-s-letra-s-module-es2015.js.map