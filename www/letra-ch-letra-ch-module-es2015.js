...
let LetraChPageModule = class LetraChPageModule {
};
...
let LetraChPage = class LetraChPage {
    constructor(router) {
        this.router = router;
        this.ocultar = false;
    }
...
//# sourceMappingURL=letra-ch-letra-ch-module-es2015.js.map