...
var AniArdillaPageModule = /** @class */ (function () {
    function AniArdillaPageModule() {
    }
...
var AniArdillaPage = /** @class */ (function () {
    function AniArdillaPage(router) {
        this.router = router;
        this.ocultar = false;
    }
    AniArdillaPage.prototype.home = function () {
        this.router.navigate(["/categorias"]);
    };
    AniArdillaPage.prototype.regresar_categoria = function () {
        this.router.navigate(["/cat-animales"]);
    };
    AniArdillaPage.prototype.siguiente = function () {
        this.router.navigate(["/ani-caballo"]);
    };
    AniArdillaPage.prototype.accion = function () {
        this.ocultar = !this.ocultar;
    };
    AniArdillaPage.ctorParameters = function () { return [
...
//# sourceMappingURL=ani-ardilla-ani-ardilla-module-es5.js.map